(() => {
  ...
  function setSync(object2) {
    return function(callback) {
      return function() {
        chrome.storage.sync.set(object2, callback);
      };
    };
  }
  function showContextMenuItem(id3) {
    return function() {
      chrome.contextMenus.update(id3, { visible: true });
    };
  }
  function hideContextMenuItem(id3) {
    return function() {
      chrome.contextMenus.update(id3, { visible: false });
    };
  }
  ...
  var setSync_ = function(record) {
    return setSync(record)(undefined2);
  };
  ...
  function querySelectorImpl(selector) {
    return function(document3) {
      return function() {
        return document3.querySelector(selector);
      };
    };
  }
  ...
  var querySelector = function(selector) {
    return function(document3) {
      return mapFlipped2(querySelectorImpl(selector)(document3))(toMaybe);
    };
  };
  ...
  function generalBracket(acquire) {
    return function(options4) {
      return function(k) {
        return Aff.Bracket(acquire, options4, k);
      };
    };
  }
  ...
  var querySelector2 = function(qs) {
    var $2 = map6(toMaybe);
  ...
  var selectElement = function(query3) {
    return bind2(liftEffect3(bindFlipped4(composeKleisliFlipped2(function() {
      var $16 = querySelector2(query3);
      return function($17) {
        return $16(toParentNode($17));
      };
    }())(document2))(windowImpl2)))(function(mel) {
  ...
  var awaitLoad = /* @__PURE__ */ makeAff(function(callback) {
    return function __do2() {
      var rs = bindFlipped4(readyState)(bindFlipped4(document2)(windowImpl2))();
      if (rs instanceof Loading) {
        var et = map8(toEventTarget)(windowImpl2)();
  ...
  var substFree = function(k) {
    var go2 = function(f) {
      ...
      if (v instanceof Bind) {
        return bind3(k(v.value0))(map10(go2)(v.value1));
      }
      ;
  ...
  var href5 = /* @__PURE__ */ prop22("href");
  ...
  var stepIndex = function(index4) {
    return function(array) {
      var $101 = (index4 + 1 | 0) < length(array);
      if ($101) {
        return index4 + 1 | 0;
      }
      ;
  ...
  var modify_4 = function(ref2) {
    return function(fn) {
      return unsafePerformEffect(modify_(fn)(ref2));
    };
  };
  var get2 = function($228) {
    return unsafePerformEffect(read($228));
  };
          ...
          return function(reason) {
            return bind6(_evalHook(reason))(function() {
              ...
              return discard1(when2(!$$null(v.evalQueue))(function() {
                var v1 = modify_4(stateRef)(function(v2) {
                  return {
                    input: v2.input,
                ...
                return discard1(sequence_2(v.evalQueue))(function() {
                  var v2 = get2(stateRef);
                  var initializeOrStepReason = eq2(reason)(Initialize2.value) || eq2(reason)(Step3.value);
                  return when2(v2.stateDirty && initializeOrStepReason)($$void5(executeHooksAndEffects(stateRef)(Step3.value)));
                });
              }()))(function() {
                return gets2(function($229) {
                  return function(v1) {
                    return v1.result;
                  }(unwrap4($229));
                });
          ...
          if (v instanceof Receive) {
            return bind6(get1)(function(v1) {
              ...
              return discard1(unless2(inputEq(v2.input)(v.value0))(function() {
                var v3 = modify_4(v1.stateRef)(function(v4) {
                  return {
                    input: v.value0,
                ...
                return $$void5(executeHooksAndEffects(v1.stateRef)(Step3.value));
              }()))(function() {
                return pure6(v.value1);
              });
            });
      ...
      var interpretHalogenHook = function(v2) {
          ...
          return bind13(liftF(new State(function(state3) {
            ...
            return discard22(function() {
              ...
              return discard22(function() {
                ...
                var v6 = modify_4(v3.stateRef)(function(s) {
                  return {
                    input: s.input,
        ...
        if (v2 instanceof Par2) {
          return liftF(new Par(retractFreeAp2(hoistFreeAp(function() {
            var $233 = evalHookM(v);
            return function($234) {
              return HalogenAp(liftFreeAp($233($234)));
            };
          }())(v2.value0))));
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at Halogen.Hooks.Internal.Eval (line 296, column 26 - line 366, column 31): " + [v2.constructor.name]);
      };
          ...
          return function(v) {
            if (v instanceof UseState) {
              if (reason instanceof Initialize2) {
                var v1 = get2(stateRef);
                var newQueue = snoc(v1.stateCells.queue)(v.value0);
                var identifier = new Tuple(v1.componentRef, length(newQueue) - 1 | 0);
                var v2 = modify_4(stateRef)(function(v32) {
                  return {
                    input: v32.input,
                    componentRef: v32.componentRef,
                    queryFn: v32.queryFn,
                    evalQueue: v32.evalQueue,
                    stateCells: {
                      queue: newQueue,
                      index: v32.stateCells.index
                    },
                    effectCells: v32.effectCells,
                    memoCells: v32.memoCells,
                    refCells: v32.refCells,
                    stateDirty: v32.stateDirty
                  };
                });
                return pure12(v.value1(new Tuple(v.value0, identifier)));
              }
              ;
              var v1 = get2(stateRef);
              var value14 = unsafeGetCell(v1.stateCells.index)(v1.stateCells.queue);
              var identifier = new Tuple(v1.componentRef, v1.stateCells.index);
              var v2 = modify_4(stateRef)(function(v32) {
                return {
                  input: v32.input,
                  componentRef: v32.componentRef,
              ...
              return pure12(v.value1(new Tuple(value14, identifier)));
            }
            ;
            if (v instanceof UseQuery) {
              var handler$prime2 = function($235) {
                return v.value1(toQueryValue($235));
              };
              var v1 = modify_4(stateRef)(function(v22) {
                return {
                  input: v22.input,
                  componentRef: v22.componentRef,
                  queryFn: new Just(toQueryFn(handler$prime2)),
                  evalQueue: v22.evalQueue,
                  stateCells: v22.stateCells,
                  effectCells: v22.effectCells,
                  memoCells: v22.memoCells,
                  refCells: v22.refCells,
                  stateDirty: v22.stateDirty
                };
              });
              return pure12(v.value2);
            }
            ;
            if (v instanceof UseEffect) {
              if (reason instanceof Initialize2) {
                var $$eval = bind6(_evalHookM(_evalHook(Queued.value))(v.value1))(function(mbFinalizer) {
                  var finalizer = fromMaybe(pure23(unit))(mbFinalizer);
                  var newQueue2 = function(st) {
                    return snoc(st.effectCells.queue)(new Tuple(v.value0, finalizer));
                  };
                  var v12 = modify_4(stateRef)(function(s) {
                    return {
                      input: s.input,
                      componentRef: s.componentRef,
                      queryFn: s.queryFn,
                ...
                var v1 = modify_4(stateRef)(function(s) {
                  return {
                    input: s.input,
                    componentRef: s.componentRef,
                    queryFn: s.queryFn,
              ...
              if (reason instanceof Step3) {
                ...
                if (v.value0 instanceof Just && v2.value0 instanceof Just) {
                  ...
                  var $182 = isEmpty(memos$prime["new"].memos) || not1(memos$prime["new"].eq)(memos$prime.old.memos)(memos$prime["new"].memos);
                  if ($182) {
                    var $$eval = bind6(_evalHookM(_evalHook(Queued.value))(applySecond2(v2.value1)(v.value1)))(function(mbFinalizer) {
                      var v32 = get2(stateRef);
                      var newFinalizer = fromMaybe(pure23(unit))(mbFinalizer);
                      var newValue2 = new Tuple(v.value0, newFinalizer);
                      var newQueue2 = unsafeSetCell(v1.effectCells.index)(newValue2)(v32.effectCells.queue);
                      var v4 = modify_4(stateRef)(function(v5) {
                        return {
                          input: v5.input,
                    ...
                    var v3 = modify_4(stateRef)(function(s) {
                      return {
                        input: s.input,
                        componentRef: s.componentRef,
                        queryFn: s.queryFn,
                  ...
                  ;
                  var v3 = modify_4(stateRef)(function(v4) {
                    return {
                      input: v4.input,
                      componentRef: v4.componentRef,
                      queryFn: v4.queryFn,
              ...
              ;
              throw new Error("Failed pattern match at Halogen.Hooks.Internal.Eval (line 140, column 5 - line 224, column 17): " + [reason.constructor.name]);
            }
            ;
            if (v instanceof UseMemo) {
              if (reason instanceof Initialize2) {
                ...
                var v2 = modify_4(stateRef)(function(v32) {
                  return {
                    ...
                    queryFn: v32.queryFn,
                    evalQueue: v32.evalQueue,
                    stateCells: v32.stateCells,
                    effectCells: v32.effectCells,
                    memoCells: {
                      queue: snoc(v1.memoCells.queue)(new Tuple(v.value0, newValue)),
                      index: v32.memoCells.index
                    },
                    refCells: v32.refCells,
                    stateDirty: v32.stateDirty
                  };
                });
                return pure12(v.value2(newValue));
              }
              ;
              var v1 = get2(stateRef);
              var nextIndex = stepIndex(v1.memoCells.index)(v1.memoCells.queue);
              var m = function() {
                var v22 = bimap3(fromMemoValues)(fromMemoValue)(unsafeGetCell(v1.memoCells.index)(v1.memoCells.queue));
                var newMemos = fromMemoValues(v.value0);
                return {
                  eq: newMemos.eq,
                  old: v22.value0.memos,
                  "new": newMemos.memos,
                  value: v22.value1
                };
              }();
              var $211 = isEmpty(m["new"]) || !m.eq(m["new"])(m.old);
              if ($211) {
                var newValue = v.value1(unit);
                var newQueue = unsafeSetCell(v1.memoCells.index)(new Tuple(v.value0, newValue))(v1.memoCells.queue);
                var v2 = modify_4(stateRef)(function(v32) {
                  return {
                    input: v32.input,
                    componentRef: v32.componentRef,
              ...
              return pure12(v.value2(m.value));
            }
            ;
            if (v instanceof UseRef) {
              if (reason instanceof Initialize2) {
                var v1 = get2(stateRef);
                var ref2 = unsafePerformEffect($$new(v.value0));
                var v2 = modify_4(stateRef)(function(v32) {
                  return {
                    input: v32.input,
                    componentRef: v32.componentRef,
                    ...
                    memoCells: v32.memoCells,
                    refCells: {
                      queue: snoc(v1.refCells.queue)(ref2),
                      index: v32.refCells.index
                    },
                    stateDirty: v32.stateDirty
                  };
                });
                return pure12(v.value1(new Tuple(v.value0, ref2)));
              }
              ;
              var v1 = get2(stateRef);
              var ref2 = unsafeGetCell(v1.refCells.index)(v1.refCells.queue);
              var value14 = unsafePerformEffect(read(ref2));
              var v2 = modify_4(stateRef)(function(v32) {
                return {
                  input: v32.input,
                  componentRef: v32.componentRef,
                  ...
                  memoCells: v32.memoCells,
                  refCells: {
                    queue: v32.refCells.queue,
                    index: stepIndex(v1.refCells.index)(v1.refCells.queue)
                  },
                  stateDirty: v32.stateDirty
                };
              });
              return pure12(v.value1(new Tuple(value14, ref2)));
            }
            ;
            throw new Error("Failed pattern match at Halogen.Hooks.Internal.Eval (line 106, column 49 - line 287, column 41): " + [v.constructor.name]);
          };
        };
      };
    };
            ...
            if (v1 instanceof Subscribe) {
              return bind14(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind14(liftEffect4(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind14(liftEffect4(read(ref2)))(function(v2) {
                    return discard12(liftEffect4(modify_(map23(insert4(sid)(finalize)))(v2.subscriptions)))(function() {
  ...
  var runUI2 = function(component2) {
    return function(i2) {
      return function(element3) {
        return bind16(liftEffect6(map19(toDocument)(bindFlipped7(document2)(windowImpl2))))(function(document3) {
  ...
  var hiddenScrollbars = "hidden";
  var fillStartZoom = "fill";
  var fillIfLargerStartZoom = "fillIfLarger";
  var enhancedControls = "enhanced";
  ...
  var discard24 = /* @__PURE__ */ discard8(bindHookM);
  var value13 = /* @__PURE__ */ value12(isPropString);
  var bind9 = /* @__PURE__ */ bind(bindEffect);
  var bind17 = /* @__PURE__ */ bind(bindHookM);
  var pure14 = /* @__PURE__ */ pure(applicativeHookM);
  ...
  var getSyncObjectAff = function(object2) {
    return makeAff(function(cont) {
      return function __do2() {
        getSyncObject(object2)(function(object$prime) {
          return cont(new Right(object$prime));
        })();
        return nonCanceler;
      };
    });
  };
  var feedback = /* @__PURE__ */ p_([/* @__PURE__ */ text6("Feel free to leave any feedback you might have on the "), /* @__PURE__ */ a([/* @__PURE__ */ href5("https://chrome.google.com/webstore/detail/enhanced-image-viewer/gefiaaeadjbmhjndnhedfccdjjlgjhho/support"), /* @__PURE__ */ target5("_blank")])([/* @__PURE__ */ text6("extension's Chrome web store page")]), /* @__PURE__ */ text6(".")]);
  var defaultOptions = {
    licenseKey: nullImpl,
  ...
  var class_2 = function($194) {
    return class_(ClassName($194));
  };
  var contextMenu = function(dictMonadEffect) {
    var liftEffect12 = liftEffect(monadEffectHookM(dictMonadEffect));
    return component(function(v) {
      return function(v1) {
        return bind5(useState(v1.contextMenu))(function(v2) {
          return pure5(label4([class_2("option")])([text6('Show "View image in same tab" context menu item:'), input([type_19(InputCheckbox.value), checked2(v2.value0 === "shown"), onChecked(function(checked3) {
            ...
            return discard24(modify_3(v2.value1)($$const(newContextMenu)))(function() {
              return discard24(liftEffect12(setSync_({
                contextMenu: newContextMenu
              })))(function() {
                return liftEffect12(function() {
                  if (checked3) {
                    return showContextMenuItem(contextMenuItemId);
                  }
                  ;
                  return hideContextMenuItem(contextMenuItemId);
                }());
              });
            });
          })])]));
  ...
  var controls2 = function(dictMonadEffect) {
    var liftEffect12 = liftEffect(monadEffectHookM(dictMonadEffect));
    return component(function(v) {
      return function(v1) {
        return bind5(useState(v1.controls))(function(v2) {
          return pure5(div_([div2([class_2("option")])([span_([text6("Controls:")]), label4([class_2("radio-label")])([input([type_19(InputRadio.value), name15("controls"), value13(defaultControls), checked2(v2.value0 === defaultControls), onValueChange(function(value1) {
            return discard24(modify_3(v2.value1)($$const(value1)))(function() {
              return liftEffect12(setSync_({
                controls: value1
              }));
            });
          })]), text6("Chrome default")]), label4([class_2("radio-label")])([input([type_19(InputRadio.value), name15("controls"), value13(enhancedControls), checked2(v2.value0 === enhancedControls), onValueChange(function(value1) {
            return discard24(modify_3(v2.value1)($$const(value1)))(function() {
              return liftEffect12(setSync_({
                controls: value1
              }));
            });
          })]), text6("Enhanced")])]), div_([text6("Chrome default controls use:"), ul_([li_([text6("Mousewheel for vertical scrolling.")]), li_([text6("Ctrl + mousewheel for zooming.")])]), text6("Enhanced controls use:"), ul_([li_([text6("Mousewheel for zooming.")]), li_([text6("Ctrl + mousewheel for vertical scrolling.")])]), text6("All controls:"), ul_([li_([text6("Left mouse button click - scale image to fit window or to actual size")]), li_([text6("Left mouse button drag - pan image")]), li_([text6("Ctrl + Left mouse button drag - default Chrome behavior")]), br_, li_([text6("Mousewheel - " + function() {
            var $139 = v2.value0 === "default";
            if ($139) {
              return "scroll vertically";
            }
            ;
            return "zoom image";
          }())]), li_([text6("Ctrl + Mousewheel - " + function() {
            var $140 = v2.value0 === "default";
            if ($140) {
              return "zoom image";
            }
            ;
            return "scroll vertically";
          }())]), li_([text6("Shift + Mousewheel - scroll horizontally")]), li_([text6("Alt + Mousewheel - rotate image")]), br_, li_([text6("H key - flip image horizontally")]), li_([text6("V key - flip image vertically")]), br_, li_([text6("Q key - rotate image 90 degrees counter-clockwise")]), li_([text6("E key - rotate image 90 degrees clockwise")]), br_, li_([text6("P key - pixelate image")])])])]));
        });
      };
    });
  };
  var position2 = function(dictMonadEffect) {
    var liftEffect12 = liftEffect(monadEffectHookM(dictMonadEffect));
    return component(function(v) {
      return function(v1) {
        return bind5(useState(v1.position))(function(v2) {
          return pure5(div2([class_2("option")])([span3([])([text6("Image position:")]), label4([class_2("radio-label")])([input([type_19(InputRadio.value), name15("position"), value13(topLeftPosition), checked2(v2.value0 === topLeftPosition), onValueChange(function(value1) {
            return discard24(modify_3(v2.value1)($$const(value1)))(function() {
              return liftEffect12(setSync_({
                position: value1
              }));
            });
          })]), text6("Top left corner")]), label4([class_2("radio-label")])([input([type_19(InputRadio.value), name15("position"), value13(centerPosition), checked2(v2.value0 === centerPosition), onValueChange(function(value1) {
            return discard24(modify_3(v2.value1)($$const(value1)))(function() {
              return liftEffect12(setSync_({
                position: value1
              }));
  ...
  var scrollbars = function(dictMonadEffect) {
    var liftEffect12 = liftEffect(monadEffectHookM(dictMonadEffect));
    return component(function(v) {
      return function(v1) {
        return bind5(useState(v1.scrollbars))(function(v2) {
          return pure5(label4([class_2("option")])([text6("Show scrollbars:"), input([type_19(InputCheckbox.value), checked2(v2.value0 === shownScrollbars), onChecked(function(checked3) {
            var newScrollbars = function() {
              if (checked3) {
                return shownScrollbars;
              }
              ;
              return hiddenScrollbars;
            }();
            return discard24(modify_3(v2.value1)($$const(newScrollbars)))(function() {
              return liftEffect12(setSync_({
  ...
  var startZoom = function(dictMonadEffect) {
    var liftEffect12 = liftEffect(monadEffectHookM(dictMonadEffect));
    return component(function(v) {
      return function(v1) {
        return bind5(useState(v1.startZoom))(function(v2) {
          return pure5(div2([class_2("option")])([span3([])([text6("Start zoom:")]), label4([class_2("radio-label")])([input([type_19(InputRadio.value), name15("startZoom"), value13(actualStartZoom), checked2(v2.value0 === actualStartZoom), onValueChange(function(value1) {
            return discard24(modify_3(v2.value1)($$const(value1)))(function() {
              return liftEffect12(setSync_({
                startZoom: value1
              }));
            });
          })]), text6("Actual size")]), label4([class_2("radio-label")])([input([type_19(InputRadio.value), name15("startZoom"), value13(fillStartZoom), checked2(v2.value0 === fillStartZoom), onValueChange(function(value1) {
            return discard24(modify_3(v2.value1)($$const(value1)))(function() {
              return liftEffect12(setSync_({
                startZoom: value1
              }));
            });
          })]), text6("Fill window")]), label4([class_2("radio-label")])([input([type_19(InputRadio.value), name15("startZoom"), value13(fillIfLargerStartZoom), checked2(v2.value0 === fillIfLargerStartZoom), onValueChange(function(value1) {
            return discard24(modify_3(v2.value1)($$const(value1)))(function() {
              return liftEffect12(setSync_({
                startZoom: value1
              }));
            });
          })]), text6("Fill window if larger")])]));
        });
      };
    });
  };
  var backgroundColor = function(dictMonadEffect) {
    var liftEffect12 = liftEffect(monadEffectHookM(dictMonadEffect));
    return component(function(v) {
      return function(v1) {
        return bind5(useState(v1.backgroundColor))(function(v2) {
          return pure5(label4([class_2("option")])([text6("Background color:"), input([type_19(InputColor.value), value13(v2.value0), onValueChange(function(value1) {
            return discard24(modify_3(v2.value1)($$const(value1)))(function() {
              return liftEffect12(setSync_({
  ...
  var options3 = function(dictMonadAff) {
    var liftAff2 = liftAff(monadAffHookM(dictMonadAff));
    var MonadEffect0 = dictMonadAff.MonadEffect0();
    var backgroundColor1 = backgroundColor(MonadEffect0);
    var startZoom1 = startZoom(MonadEffect0);
    var position1 = position2(MonadEffect0);
    var scrollbars1 = scrollbars(MonadEffect0);
    var contextMenu1 = contextMenu(MonadEffect0);
    var controls1 = controls2(MonadEffect0);
    return component(function(v) {
      return function(v1) {
        return bind5(useState(Nothing.value))(function(v2) {
          return discard3(useLifecycleEffect(bind17(liftAff2(getSyncObjectAff(defaultOptions)))(function(extensionOptions$prime) {
            return discard24(modify_3(v2.value1)($$const(new Just(extensionOptions$prime))))(function() {
            ...
            return pure5(function() {
              ...
              if (v2.value0 instanceof Just) {
                return div_([slot_1($$Proxy.value)(unit)(backgroundColor1)(v2.value0.value0), slot_22($$Proxy.value)(unit)(startZoom1)(v2.value0.value0), slot_3($$Proxy.value)(unit)(position1)(v2.value0.value0), slot_4($$Proxy.value)(unit)(scrollbars1)(v2.value0.value0), slot_5($$Proxy.value)(unit)(contextMenu1)(v2.value0.value0), slot_6($$Proxy.value)(unit)(controls1)(v2.value0.value0), feedback]);
              }
              ;
              throw new Error("Failed pattern match at Options.Main (line 345, column 16 - line 357, column 14): " + [v2.value0.constructor.name]);
            }());
          });
        });
      };
  ...
  var options1 = /* @__PURE__ */ options3(monadAffAff);
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind22(awaitBody)(function() {
    return bind22(liftEffect7(mapFlipped3(mapFlipped3(bind9(bind9(window2)(document))(querySelector("#options-spa")))(fromJust4))(unsafeCoerce2)))(function(v) {
      return runUI2(options1)(unit)(v);
    });
  }));
