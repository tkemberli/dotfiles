...
floatMiddleSmall = customFloating $ W.RationalRect (0.4) (0.4) (0.5) (0.5)
...
myManageHook = composeAll[
    ...
    title =? "Save File" --> doFloat] <+> namedScratchpadManageHook scratchpads
...
myConfig = ewmhFullscreen $ ewmh $ def {
    ...
    XMonad.workspaces workspaces = myWorkspaces,
